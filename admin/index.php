...
<body>
  ...
  <div class="dashboard" id="admin_dashboard">
    <div class="menu">
      ...
      <?php 
        $dashboard_categories = ["Në Pritje", "Te aprovuara","Kontaktet","Produktet"];
        $dashboard_categories_files_name = ["pending", "approved", "contacts","products"];
        $i_class = ["fas fa-history", "fas fa-clipboard-check", "fas fa-envelope", "fas fa-shopping-basket"];
      ?>
